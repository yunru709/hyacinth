...
//
// ── 可扩展方向 ──────────────────────────────────────────────
// 陪伴模式只是这套 Router 的**一个预置用法**，模式本身与「陪伴」无关
// （它换的只是：人设 / 记忆源 / 工具集 / 跳过哪些 section）。
// 「专精工作台 · 工作-生活分渠 · 受限对外模式 · 记忆作用域 · 场景化定时任务」
// 这些延伸方向、三条已知约束、以及让它们变便宜的两件前置改造，
// 统一记在 **context/profiles.ts 头部「可扩展方向」整段**（仅记录，未采纳）。
// ============================================================
