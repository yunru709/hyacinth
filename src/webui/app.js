...
(function () {
  ...
  const THEMES = [
    ...
    { id: 'mono', name: '极简', desc: '素白 · 灰度 · 无装饰',
      swatches: ['#fbfbfc', '#f4f4f5', '#35353a', '#606067', '#18181b'] },
    { id: 'cyber', name: '赛博朋克', desc: '霓虹洋红 · 电子青 · 硬直角',
      swatches: ['#07060d', '#0b0a14', '#e07fee', '#79e8f7', '#eae6ff'] },
    { id: 'paper', name: '报纸', desc: '米黄纸 · 墨字 · 衬线',
      swatches: ['#faf5ec', '#f3ecdd', '#4a4438', '#913521', '#241f17'] },
    { id: 'terminal', name: '终端', desc: '纯黑 · 荧光绿 · 等宽',
      swatches: ['#020603', '#07120a', '#39ca6e', '#face60', '#d9ffe3'] },
    { id: 'sunset', name: '日落', desc: '暖橙 · 霞粉 · 大圆角',
      swatches: ['#1b0d1e', '#221026', '#fca255', '#f588c0', '#f7ecf5'] },
    { id: 'glacier', name: '冰川', desc: '冷白 · 钢蓝 · 冰青',
      swatches: ['#fbfdfe', '#f4f9fd', '#275fe2', '#158ba5', '#16233a'] },
  ];
