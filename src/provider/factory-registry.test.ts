...
import { PROVIDER_FACTORIES, PROVIDER_TYPES, registerProviderFactory } from './factory-registry.js';
...
const EXPECTED_TYPES = [
  ...
  'openrouter', 'moonshot', 'qwen', 'zhipu', 'minimax', 'mimo',
...
const ALL_ENV_KEYS = [
  ...
  'ZHIPU_API_KEY', 'MINIMAX_API_KEY', 'MIMO_API_KEY',
];
...
describe('PROVIDER_FACTORIES 守卫（注册表自洽，P5-15）', () => {
  ...
  it('守卫 3：DEFAULT_PROVIDERS 仅含 12 在线厂商，local 三态自动排除，且与注册表同源', () => {
